    ...
    return new Promise((resolve, reject) => {
        ...
        fs.createReadStream(filePath)
            ...
            .on('data', (data) => {
                ...
                const customerDemand = parseInt(data['Rounded_Scaled_Units_at_46.88']) || 4;
 ...
 */
async function runGameWithSimplePolicy(gameContract, signers, hasBlockchainVisibility, demandPattern = 0, weeks = 69) {
...
async function main() {
    try {
        ...
        const simDirName = '1-2-46-simulation'; // New directory for these results, named after the script
