    ...
    return new Promise((resolve, reject) => {
        ...
        fs.createReadStream(filePath)
            ...
            .on('data', (data) => {
                ...
                const customerDemand = parseInt(data['Rounded_Scaled_Units_at_48.36']) || 4;
...
async function main() {
    try {
        ...
        const simDirName = '1-2-48-simulation'; // New directory for these results, named after the script
