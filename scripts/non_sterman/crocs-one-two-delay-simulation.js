/**
 * Crocs Supply Chain Simulation Script with One Week Order Delay and Two Week Shipping Delay
 * 
...
async function runSimulation(customerDemandData, periods, useBlockchain, label) {
    ...
    const dataPath = path.join(__dirname, `../visualization/data_${visibilityLabel}_crocs_one_two_delay_${periods}_periods.json`);
    try {
...
async function main() {
    try {
        console.log("Starting Crocs Supply Chain Simulations with One Week Order Delay and Two Week Shipping Delay");
        console.log("=============================================================\n");
        ...
        // Create summary file
        const summaryPath = path.join(__dirname, '../visualization/one_two_delay_simulation_summary.csv');
