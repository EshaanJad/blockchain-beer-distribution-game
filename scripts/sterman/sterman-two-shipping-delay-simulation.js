...
function loadCustomDemandData(filePath) {
    return new Promise((resolve, reject) => {
        ...
        fs.createReadStream(filePath)
            .pipe(csv())
            .on('data', (data) => {
                // Extract customer demand from the "Rounded_Scaled_Units_at_50" column
                const customerDemand = parseInt(data['Rounded_Scaled_Units_at_48.54']) || 4;
...
async function main() {
    try {
        ...
        const simDir = path.join(vizDir, 'data/simulations/sterman/two-shipping-delay');
        ...
        await gameTraditional.setInitialInventory(12); // Default initial inventory
        ...
        console.log("\n===== RUNNING BLOCKCHAIN-ENABLED SIMULATION (WITH STICKY INFO) =====\n");
        ...
        await gameBlockchain.setInitialInventory(12); // Default initial inventory
