...
async function main() {
    try {
        ...
        const simDir = path.join(vizDir, 'data/simulations/sterman/one-zero-delay');
        ...
        // Set delay periods - One week order delay, zero week shipping delay
        ...
        const summaryObject = {
            DataSource: "one_zero_delay_simulation",
            Periods: periods,
