/**
 * Sterman Heuristic Simulation for Beer Distribution Game with Two Week Order Delay and Two Week Shipping Delay
 * 
 ...
 * 
 * Parameters:
 * - Order Delay: 2 weeks (orders take 2 weeks to reach the upstream supplier)
...
async function main() {
    try {
        ...
        const simDir = path.join(vizDir, 'data/simulations/sterman/two-order-two-shipping-delay');
        ...
        // Set delay periods - Two week order delay, two week shipping delay
        ...
        const summaryObject = {
            DataSource: "two_order_two_shipping_delay_simulation",
            Periods: periods,
