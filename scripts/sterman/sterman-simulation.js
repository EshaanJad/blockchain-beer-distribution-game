...
async function main() {
    try {
        ...
        const traditionalPath = path.join(vizDir, 'data_traditional_sterman.json');
        ...
        const blockchainPath = path.join(vizDir, 'data_blockchain_sterman.json');
        ...
        // Save summary to CSV
        const summaryPath = path.join(vizDir, 'sterman_simulation_summary.csv');
