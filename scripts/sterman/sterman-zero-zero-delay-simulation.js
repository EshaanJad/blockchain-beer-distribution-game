/**
 * Sterman Heuristic Simulation for Beer Distribution Game with Zero Order Delay and Zero Week Shipping Delay
 * 
...
async function main() {
    try {
        ...
        const simDir = path.join(vizDir, 'data/simulations/sterman/zero-order-zero-shipping-delay');
        ...
        // Set delay periods - Zero order delay, zero week shipping delay
        ...
        const summaryObject = {
            DataSource: "zero_order_zero_shipping_delay_simulation",
            Periods: periods,
