/**
 * Sterman Heuristic Simulation for Beer Distribution Game with Zero Order Delay
 * 
...
async function main() {
    try {
        ...
        // Set delay periods - Zero order delay, one week shipping delay
        ...
        const traditionalPath = path.join(vizDir, 'data_traditional_sterman_zero_delay.json');
        ...
        const blockchainPath = path.join(vizDir, 'data_blockchain_sterman_zero_delay.json');
        ...
        // Save summary to CSV
        const summaryPath = path.join(vizDir, 'sterman_zero_delay_simulation_summary.csv');
