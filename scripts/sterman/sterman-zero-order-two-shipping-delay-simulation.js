/**
 * Sterman Heuristic Simulation for Beer Distribution Game with Zero Order Delay and Two Week Shipping Delay
 * 
...
async function main() {
    try {
        ...
        const simDir = path.join(vizDir, 'data/simulations/sterman/zero-order-two-shipping-delay');
        ...
        // Set delay periods - Zero order delay, two week shipping delay
        ...
        const summaryObject = {
            DataSource: "zero_order_two_shipping_delay_simulation",
            Periods: periods,
