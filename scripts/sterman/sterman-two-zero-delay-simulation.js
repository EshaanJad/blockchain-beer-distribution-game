/**
 * Sterman Heuristic Simulation for Beer Distribution Game with One Week Order Delay and Zero Week Shipping Delay
 * 
 ...
 * 
 * Parameters:
 * - Order Delay: 2 week (orders take 2 week to be received by the upstream supplier)
 * - Shipping Delay: 0 weeks (shipments take 0 weeks to arrive at the downstream partner)
 * 
...
async function main() {
    try {
        ...
        // Number of periods to simulate (use length of demand data or default to 69)
        ...
        const simDir = path.join(vizDir, 'data/simulations/sterman/two-zero-delay');
        ...
        // Set delay periods - Two week order delay, zero week shipping delay
        await gameTraditional.setOrderDelayPeriod(2);
        console.log("Order delay set to 2 week");
        
        await gameTraditional.setShippingDelayPeriod(0);
        console.log("Shipping delay set to 0 weeks");
        ...
        // Set delay periods - Two week order delay, zero week shipping delay
        await gameBlockchain.setOrderDelayPeriod(2);
        console.log("Order delay set to 2 week");
        
        await gameBlockchain.setShippingDelayPeriod(0);
        console.log("Shipping delay set to 0 weeks");
        ...
        const summaryObject = {
            DataSource: "two_zero_delay_simulation",
            Periods: periods,
