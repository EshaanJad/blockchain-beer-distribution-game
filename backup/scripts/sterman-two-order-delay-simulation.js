/**
 * Sterman Heuristic Simulation for Beer Distribution Game with Two Week Order Delay
 * 
...
async function main() {
    try {
        ...
        // Set delay periods - Two weeks order delay, one week shipping delay
        ...
        const traditionalPath = path.join(vizDir, 'data_traditional_sterman_two_order_delay.json');
        ...
        const blockchainPath = path.join(vizDir, 'data_blockchain_sterman_two_order_delay.json');
        ...
        // Save summary to CSV
        const summaryPath = path.join(vizDir, 'sterman_two_order_delay_simulation_summary.csv');
