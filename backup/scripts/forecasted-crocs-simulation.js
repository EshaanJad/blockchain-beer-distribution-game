/**
 * Forecasted Crocs Supply Chain Simulation Script for Beer Distribution Game
 * 
 ...
 * across a longer time horizon with forecasted data.
 * 
...
async function main() {
    try {
        console.log("Starting Forecasted Crocs Supply Chain Simulations");
        console.log("=================================================\n");
        ...
        // Create summary file
        const summaryPath = path.join(__dirname, '../visualization/forecasted_simulation_summary.csv');
