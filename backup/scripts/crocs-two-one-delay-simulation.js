/**
 * Crocs Supply Chain Simulation Script with Two Week Order Delay and One Week Shipping Delay
 * 
...
async function runSimulation(customerDemandData, periods, useBlockchain, label) {
    ...
    const dataPath = path.join(__dirname, `../visualization/data_${visibilityLabel}_crocs_two_one_delay_${periods}_periods.json`);
    try {
...
async function main() {
    try {
        console.log("Starting Crocs Supply Chain Simulations with Two Week Order Delay and One Week Shipping Delay");
        console.log("=============================================================\n");
        ...
        // Create summary file
        const summaryPath = path.join(__dirname, '../visualization/two_one_delay_simulation_summary.csv');
